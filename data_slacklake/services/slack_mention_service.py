...
def _build_genie_usage_message() -> str:
    ...
    if commands:
        ...
        return (
            ...
            f"Exemplo: `@Databricks {first_command} quantas operações tivemos esse ano?`"
        )

    return "Me envie uma pergunta para consultar a Genie. Exemplo: `@Databricks quantas operações tivemos esse ano?`"
